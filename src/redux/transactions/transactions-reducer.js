...
const items = createReducer([], {
  ...
  [editTransaction.fulfilled]: (state, { payload }) => {console.log([payload.transaction, ...state]); 
    const editedTransactionIndex = state.findIndex(transaction => transaction._id === payload.transaction._id)
